      ...
      <div className="timeline-bg">
        <div className=" container  ">
          <div className="row">
            <div className="col-12">
              ...
              <div className="title-section row" >
                ...
                <div className="col-8 col-md-6 d-flex align-items-center justify-content-center text-center">
                  <div className="title">Our Dream Day's Timeline</div>
                </div>
            ...
            <div className="col-12">
              ...
              <div className=" row">
                ...
                <div className="col-4 col-md-2  col-lg-3 pr-0 ">
                  <hr></hr>
                </div>
          ...
          <div className=" row">
            ...
            <div className="col-2 d-flex align-items-center justify-content-center text-center px-0">
              <img src={image.loveBirds} width={"30px"} alt="Love Birds" />
            </div>
