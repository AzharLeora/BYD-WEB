export const icons = {
  ...
  isp: require('./Isp/icon.png'),

  whiteLogo:require('./WhiteLogo/logo (8).png'),

  endCal: require('./EndCall/icon.png'),

  cashOnDelivery :require('./CashOnDelivery/cashon-delivery-icon.png'),
  cardTransaction :require('./CardTransaction/card-transaction-icon.png'),
  LocationIcon:require('./LocationIcon/location-icon.svg'),
  weddingBride:require('./BookYourDay/bride.png'),
  weddingGroom:require('./BookYourDay/groom.png'),
  weddingLocation:require('./BookYourDay/location.png'),
  weddingCalendar:require('./BookYourDay/calendar.png'),
  weddingSlogan:require('./BookYourDay/wedding-contract.png'),
  birthdayChild:require('./BookYourDay/birthday-boy.png'),
  birthdayGender:require('./BookYourDay/gender.png'),
